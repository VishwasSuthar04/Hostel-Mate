...
export const CATEGORIES = [
  ...
  { id: 'dining',     label: 'بیرون کھانا', labelEn: 'Dining Out',   color: '#f59e0b', icon: '🍽️' },
  { id: 'shopping',   label: 'خریداری',    labelEn: 'Shopping',     color: '#ec4899', icon: '🛍️' },
  ...
  { id: 'fitness',    label: 'ورزش',       labelEn: 'Fitness',      color: '#22c55e', icon: '💪' },
  { id: 'subscription', label: 'سبسکرپشن', labelEn: 'Subscriptions', color: '#a855f7', icon: '📱' },
  { id: 'insurance',  label: 'انشورنس',    labelEn: 'Insurance',    color: '#78716c', icon: '🛡️' },
  { id: 'savings',    label: 'بچت',        labelEn: 'Savings',      color: '#16a34a', icon: '🏦' },
